...
public class QueryUtil extends CommonUtil {
	 ...
	 * 
	 * @see PaymentServiceImpl#addEmployees()
	 * @see PaymentServiceImpl#createEmployeeTable()
	 * @see PaymentServiceImpl#displayAllEmployees()
	 * @see PaymentServiceImpl#removeEmployee(String)
	 * 
	 */
	public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
		 ...
		 */
		nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(System.getProperty("catalina.base") + "\\wtpwebapps\\OneReddak\\WEB-INF\\Query.xml"))
